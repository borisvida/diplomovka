...
\def\veta{\proclaim Veta. }
\def\lema{\proclaim Lema. }
\def\definicia{\proclaim Definícia. }
\def\dosledok{\proclaim Dôsledok. }
\def\dokaz{\noindent{Dôkaz.}\quad}
\def\hypoteza{\proclaim Hypotéza. }
\def\priklad{\proclaim Príklad. }
...
\newcount\chyp  \chyp=0
\newcount\cex  \cex=0
\def\cveta{\advance\cvety by 1\cdosl=0\proclaim Veta \number\cvety. }
\def\clema{\advance\cvety by 1\cdosl=0\proclaim Lema \number\cvety. }
\def\cdefinicia{\advance\cdef by 1\proclaim Definícia \number\cdef. }
\def\cdosledok{\advance\cdosl by 1\proclaim Dôsledok \number\cvety.\number\cdosl. }
\def\chypoteza{\advance\chyp by 1\proclaim Hypotéza \number\chyp. }
\def\cpriklad{\advance\cex by 1\proclaim Príklad \number\cex. }
